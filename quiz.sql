...
-- Export de la structure de table quizz. enregistrements
...
-- Export de données de la table quizz.enregistrements : ~0 rows (environ)
...
INSERT INTO `questions` (`id`, `intitule`, `qcm`, `id_quiz`) VALUES
	...
	(8, 'Avec quel instrument peut-on ouvrir une porte ?', 'N', 3);
