...
-- Export de données de la table quizz.propositions : ~8 rows (environ)
...
CREATE TABLE IF NOT EXISTS `questions` (
  ...
  `id_quizz` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `FK_id_quizz` (`id_quizz`),
  CONSTRAINT `FK_id_quizz` FOREIGN KEY (`id_quizz`) REFERENCES `quizz` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;

-- Export de données de la table quizz.questions : ~2 rows (environ)
/*!40000 ALTER TABLE `questions` DISABLE KEYS */;
INSERT INTO `questions` (`id`, `intitule`, `id_quizz`) VALUES
...
-- Export de la structure de table quizz. quizz
...
-- Export de données de la table quizz.quizz : ~1 rows (environ)
